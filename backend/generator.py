...
class RAGResponseGenerator:
    ...
    def is_query_compliant(self, query: str) -> tuple[bool, str]:
        ...
        prohibited_rules = [
            ...
            (r"\b(which mutual fund should i invest|which is the best mutual fund|best mutual fund for|which fund should i buy|which fund to choose|recommend a fund|suggest a fund|top mutual fund)\b",
